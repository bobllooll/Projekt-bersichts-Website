 ...
 *     fallbackLink: "https://192.168.x.x/...", // Optional: Link wenn Haupt-URL nicht erreichbar
 *     icon: {
...
const projectsData = [
    {
        ...
        fallbackLink: "https://kalorien-tracker.pages.dev",
        icon: {
            type: "svg",
    ...
    },
    {
        ...
        fallbackLink: "https://checkliste.pages.dev",
        icon: {
            type: "image",
    ...
    },
    {
        ...
        fallbackLink: "https://g-8u6.pages.dev",
        icon: {
            type: "image",
    ...
    },
    {
        ...
        fallbackLink: "https://wetterapp.pages.dev",
        icon: {
            type: "svg",
    ...
    },
    {
        ...
        fallbackLink: "https://recap25.pages.dev",
        icon: {
            type: "svg",
    ...
    },
    {
        ...
        fallbackLink: "https://transfer-peertppeer.pages.dev",
        isPlaceholder: false,
        icon: {
            type: "svg",
